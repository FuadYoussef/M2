 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Fuad Youssef");
		  toPrint += p1.toString("fyoussef3");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Andrew");
		  toPrint += p2.toString("azhang327");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Jillian LaTour");
		  toPrint += p3.toString("903364790");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Rena Li");
                  toPrint += p4.toString("rli366");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Philena Yang");
                  toPrint += p5.toString("pyang84");
...
>>>>>>> c35384904254466a285a1db201c379462bb6e391
